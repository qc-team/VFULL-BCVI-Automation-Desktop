...
public class EResidencyQc extends ClassProperties implements InitiateChromeDriver, Login, WaitingForLoading{
...
//		mysqlConnect.startdbConnection();
	...
	public void initiateChromeDriver() {
		...
		chromeDriver.get("http://cqcehap001.qcenv.idemia.local/eresidency-qc_frontend/#/app-login");
	}
