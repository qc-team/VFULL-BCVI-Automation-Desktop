...
public class EVisaPrivateImplementation extends ClassProperties implements InitiateChromeDriver, Login, WaitingForLoading{
	
	public EVisaPrivateImplementation() {
...
//		mysqlConnect.startdbConnection();
	...
	public void initiateChromeDriver() {
		...
		chromeDriver.get("http://cqcehap001.qcenv.idemia.local/evisa-bcvi-frontend-mofa/");
	}
