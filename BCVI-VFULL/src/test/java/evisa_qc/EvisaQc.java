...
public class EvisaQc extends ClassProperties implements InitiateChromeDriver, Login, WaitingForLoading{
...
//		mysqlConnect.startdbConnection();
	...
	public void initiateChromeDriver() {
		...
		chromeDriver.get("http://cqcehap001.qcenv.idemia.local/evisa-qc-frontend/");
	}
