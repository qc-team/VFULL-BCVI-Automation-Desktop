...
public class ImmigrationImplementation extends ClassProperties implements InitiateChromeDriver, Login, WaitingForLoading{
	
	public ImmigrationImplementation() {
...
//		mysqlConnect.startdbConnection();
	...
	public void initiateChromeDriver() {
		...
		chromeDriver.get("http://cqcehap001.qcenv.idemia.local/enationality-internal_frontend/");
	}
